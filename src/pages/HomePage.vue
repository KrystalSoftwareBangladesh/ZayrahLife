  ...
  <div>
        ...
        <div class="max-w-2xl">
          ...
          <div class="flex flex-wrap gap-4">
            <RouterLink to="/products">
              <BaseButton size="lg" variant="secondary">Shop Now</BaseButton>
            </RouterLink>
            <RouterLink to="/products">
              <BaseButton size="lg" variant="outline" class="!border-white !text-white hover:!bg-white hover:!text-primary-600">
                Browse Collection
              </BaseButton>
            </RouterLink>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          <RouterLink
            ...
            class="bg-gray-50 rounded-xl p-6 text-center hover:bg-gray-100 transition-colors group"
          >
            <span class="text-4xl mb-3 block">{{ category.icon }}</span>
            <h3 class="font-semibold text-gray-900 group-hover:text-primary-600">{{ category.name }}</h3>
    ...
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
          ...
          <RouterLink to="/products" class="text-primary-600 hover:text-primary-700 font-medium">
            View All
          </RouterLink>
        </div>
    ...
    <section class="py-16 bg-primary-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-primary-100 mb-8 max-w-md mx-auto">
        ...
        <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" @submit.prevent>
          ...
          />
          <BaseButton variant="secondary" size="lg">Subscribe</BaseButton>
        </form>
      </div>
    </section>
